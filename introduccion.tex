...
Ante este problema se hicieron varias investigaciones cuyas soluciones pueden clasificarse en dos tipos: el diseño de algoritmos para minimizar las corrientes en los electroimánes y el uso de imanes permanentes para proveer un campo magnético base para la levitación.\par
...
Este equipo consiste en un eje rígido capaz de balancearse libremente sobre un punto de apoyo colocado debajo de su centro de masa. La posición angular de este eje es controlada mediante electroimánes fijados a los extremos de este. A pesar su simplicidad este equipo incorpora todas las no linealidades típicas de un rodamiento magnético activo, y la dinámica del sistema es ideal para evaluar el desempeño de los controladores.\par
...
Este capítulo tiene la finalidad de integrar todas la áreas funcionales y ver su comportamiento a través de simulaciones específicas, donde se muestra el funcionamiento en conjunto de los elementos previamente seleccionados en el capítulo 3, así como la respuesta ante ciertas perturbaciones que podrían suscitarse en el área de aplicación donde se sitúe dicho prototipo. De igual forma, se muestran los alcances de este protitipo bajo ciertos parámetros de funcionamiento.
