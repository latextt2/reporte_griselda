...
Ante este problema se hicieron varias investigaciones cuyas soluciones pueden clasificarse en dos tipos: el diseño de algoritmos para minimizar las corrientes en los electroimánes y el uso de imanes permanentes para proveer un campo magnético base para la levitación.
