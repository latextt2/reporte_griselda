...
Este documento se divide principalmente en cuatro capítulos:
...
El Marco teórico tiene como finalidad describir los conocimientos fundamentales aplicados al proyecto durante el desarrollo del mismo. Entre los más importantes están la comprensión de los fenómenos de electricidad y magnetismo, el control de sistemas lineales y discretos, los filtros de Kalman, entre otros. A su vez, refuerza y repasa los conocimientos sobre electrónica y conceptos de diseño mecatrónico (PDS y análisis funcionales) para permitir una mejor vinculación entre los elementos matemáticos de control y el fenómeno de levitación magnética.

El objetivo del capítulo del Diseño conceptual es describir la importancia del desarrollo teórico de este proyecto, así como el impacto industrial que tiene. Marca las acotaciones de las especificaciones sobre las que se diseñó el rodamiento, y establece a grosso modo la morfología del prototipo. Define también las áreas funcionales sobre las que se trabajó durante la gestación del proyecto, y muestra un análisis morfológico para determinar de forma general un diseño apropiado de qué presentación final tendría el prototipo.

El Diseño detallado describe el desarrollo de cada área funcional a detalle basándose en los procedimientos descritos en el capítulo 1 y retoma los bocetos del diseño conceptual en el capítulo 2. Esto con el fin de que para el final de este capítulo, se obtenga una simulación que cumpla los requerimientos planteados previamente. Abarca distintas pruebas aplicando cálculos teorizados sobre simulaciones para que a partir de ellas, se compare el comportamiento de cada uno de los módulos y se determinen los elementos con mejores resultados para implementarlos en la simulación final en conjunto.

Finalmente el capítulo de Validación y análisis de resultados tiene la finalidad de integrar todas la áreas funcionales y observar su comportamiento a través de simulaciones específicas, donde se muestra el funcionamiento en conjunto de los elementos previamente seleccionados en el capítulo 3, así como la respuesta ante ciertas perturbaciones que podrían suscitarse en el área de aplicación donde se sitúe el diseño. De igual forma, se muestran los alcances de este diseño bajo ciertos parámetros de funcionamiento.
