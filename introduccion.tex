...
\subsubsection{Capitúlo 1: Marco Teórico}

En el capitulo tiene como finalidad describira los conocimientos fundamentales que se aplicaron al proyecto para la realizacion de este, tales como electricidad y magentismos conceptos de fisca, de control de sistemas lineales y discretos. Asi mismo, como conocimientos electricos electronicos, al igual manera conceptos de diseño mecatronico tales como  PDS, analisis funcionales.

\subsubsection{Capiúlo 2:Dise\~no Conpceptual}

:V

\subsubsection{Capitúlo 3: Dise\~no Detallado}

:v

\subsubsection{Capitúlo 4: Validaci\'on y An\'alisis de Resultados}
