...
\begin{figure}[htb]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        ...
        %\label{fig:rmr:diagrama-de-fuerzas}
    \end{subfigure}
    \caption{Salida del sistema: Eje $Y$. Control integral discreto (azul) y control integral discreto calendarizado (rojo), mostrando ambas curvas superpuestas en los gráficos. $\omega_s = 10000 \frac{rad}{s}$.}
...
\begin{figure}[htb]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        ...
        %\label{fig:rmr:diagrama-de-fuerzas}
    \end{subfigure}
    \caption{Salida del sistema: Eje $Z$. Control integral discreto (azul) y control integral discreto calendarizado (rojo), mostrando ambas curvas superpuestas en los gráficos. $\omega_s = 10000 \frac{rad}{s}$.}
...
Cuando trabajan a velocidades angulares diferentes, el controlador no calendarizado presenta problemas para estabilizar el rotor debido a los efectos de la precesión. En cambio el control calendarizado no presenta problemas (fig. \ref{fig:Controlador_linealizado_vs_Controlador_calendarizado_ws_30000_eje_y}, \ref{fig:Controlador_linealizado_vs_Controlador_calendarizado_ws_30000_eje_z}, \ref{fig:Controlador_linealizado_vs_Controlador_calendarizado_ws_30000_eje_x}).  

\newpage

\section{Simulación del accionamiento híbrido} 

Esta simulación consiste en un controlador integral y observador discreto calendarizado con un $\omega_s = 10000 \frac{rad}{s}$ y con las condiciones iniciales:
...
\end{tabular}
\caption{Condiciones Iniciales: Accionamiento híbrido.}
\end{table}
...
\begin{figure}[htb]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        ...
        %\label{fig:rmr:diagrama-de-fuerzas}
    \end{subfigure}
    \caption{Salida del sistema: Eje $Y$. Simulación con carga combinada, MCCE desactivado.}
...
\begin{figure}[htb]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        ...
        %\label{fig:rmr:diagrama-de-fuerzas}
    \end{subfigure}
    \caption{Salida del sistema: Eje $Z$. Simulación con carga combinada, MCCE desactivado.}
    \label{fig:Simulacion_carga_combinada_MCCE_desactivada_eje_y}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Salida del sistema: Eje $X$. Simulación con carga combinada, MCCE desactivado.}
...
\begin{figure}[htb]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        ...
        %\label{fig:rmr:diagrama-de-fuerzas}
    \end{subfigure}
    \caption{Salida del sistema: Eje $Y$. Simulación con carga combinada, MCCE activado.}
...
\begin{figure}[htb]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        ...
        %\label{fig:rmr:diagrama-de-fuerzas}
    \end{subfigure}
    \caption{Salida del sistema: Eje $Z$. Simulación con carga combinada, MCCE activado.}
    \label{fig:Simulacion_carga_combinada_MCCE_activada_eje_y}
\end{figure}
...
\begin{figure}[htb]
    ...
    \caption{Salida del sistema: Eje $X$. Simulación con carga combinada, MCCE activado.}
    \label{fig:Simulacion_carga_combinada_MCCE_activada_eje_x}
\end{figure}

\newpage

Se puede apreciar de las figuras (\ref{fig:Simulacion_carga_combinada_MCCE_desactivada_eje_y}-\ref{fig:Simulacion_carga_combinada_MCCE_desactivada_eje_x}) a (\ref{fig:Simulacion_carga_combinada_MCCE_activada_eje_y}-\ref{fig:Simulacion_carga_combinada_MCCE_activada_eje_x}) que activar el lazo de control del MCCE no compromete la estabilidad del sistema. A continuación se muestran los efectos en los electroimanes en ambos casos, cuando el MCCE se encuentra desactivado, y cuando se activa el MCCE. 
...
\begin{figure}[htb]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        ...
        %\label{fig:rmr:diagrama-de-fuerzas}
    \end{subfigure}
    \caption{Fuerzas ejercida por el imán permanente (MCCE desactivado): Eje $Z$.}
...
\begin{figure}[htb]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        ...
        %\label{fig:rmr:diagrama-de-fuerzas}
    \end{subfigure}
    \caption{Fuerzas ejercida por el imán permanente (MCCE activado): Eje $Z$.}
...
En ambos casos, los controladores logran compensar las fuerzas combinadas que se les aplica y rápidamente convergen al origen.