...
Finalmente con el máximo ubicado $\alpha = 0.274$ que se obtiene de la figura \ref{fig:grafica_capacitancia_optima} se ejecuta otro script que varía la distancia entre el objetivo y el sensor para obtener la curva característica mostrada en la figura \ref{fig:sensor_caracterizacion_final_radial}.
