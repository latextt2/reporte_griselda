...
\subsection{Selecci\'on de Material} \label{sec:seleccion-somaloy}
...
\subsection{Calculo de la bobina} \label{sec:radial-calculo-bobina}
...
El problema es que el incremento y decremento de la corriente actúan de forma asimétrica, entonces para obtener cargas y descargas simétricas será necesario aplicar un voltaje de $-V_{cc}$ durante el ciclo de descarga. Para eso es necesaria una configuración como la mostrada en la figura [...]

[insertar figura medio puente H]
...
Otro problema consiste en polarizar los transistores de la figura [...], ya que para su correcta activación es necesario un voltaje de compuerta de hasta $V_{cc} + V{sat}$. 
...
\subsection{Calculo de la bobina}
...
Cabe destacar que el modelado desarrollado en la sección \ref{sec:flujo-marginal} el cual toma en cuenta los efectos del flujo marginal coincide con los resultados de la simulación FEM. 1
