...
Podemos observar que este sistema de ecuaciones es no lineal, así que tenemos que linealizarlo para convertirlo en la forma canónica de espacio de estados, y aplicar las técnicas de control descritas en la sección \ref{sec:control} mediante las fórmulas \ref{eq:control:jacobiano}, lo que resulta en el sistema lineal calculado en el script \ref{ap:sistema-ecuaciones-lineales}
