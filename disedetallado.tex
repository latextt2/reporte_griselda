...
Para diseñar un electriman requerimos de modelo que relacione la geometria del nucleo con la fuerza que este puede ejercer. Sabemos por la ecuacion ?? que la fuerza esta determida por
\begin{equation}
...
\begin{center}
\centering
\missingfigure[figwidth=8cm]{Inercia del RMH}
\caption{Inercia del RMH}
...
\end{equation}
Existe un problema con simpflicar la accion conjunta de los electroimanes axiales en xx, es posible ver que el momento generado cuando la fuerza es xx es xx, y el torque generado cuando la fuerza es xx va en el mismo sentido, entonces tenemos que el momento que ejerce los electrimanes raidales es
\begin{equation}
