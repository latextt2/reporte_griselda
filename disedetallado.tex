...
Como se explica en la sección \ref{sec:calc-conductores}, la relación entre el número de vueltas y corriente depende del balance entre eficiencia y respuesta en frecuencia. Se optó por utilizar una corriente de 2 A debido a la gran disponibilidad de componentes electrónicos que operan a este valor de corriente, además de ser un valor lo suficientemente algo como para que la inductancia no degrade la respuesta en frecuencia del electroimán. 
