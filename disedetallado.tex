...
Fuerza sacada del culo 

$$F_{max} = 50[N]$$

La distancia es la usada comunmente para el diseño de RM (referencias)
$$y_{max} = 0.75[mm]$$
$$y_{min} = 0.25[mm]$$

Usando el material seleccionado y estos nuevos datos y siguiendo los pasos de la seccion [electroimanes] resulta en esta area 
$$A = 288[mm^2]$$
...
La razon de elegir 2 A fue porque es mas sencillo realizar una electronica mas eficiente a ese valor
$$I = 2[A]$$

Usando las formulas de conductores se calculan las vueltas 
$$N = 278[vueltas]$$

Usando las formulas de calculo de conductores se calcula el area 
$$A_b = 254[mm^2]$$
