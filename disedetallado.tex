...
Finalmente se ejecuta otro script que varía la distancia entre el objetivo y el sensor para obtener la curva característica mostrada en la figura \ref{fig:sensor_caracterizacion_final_radial}.
