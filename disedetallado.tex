...
Sustituyendo los términos descritos en la sección \ref{sec:modelo-dinamico} en la ecuación \ref{eq:derivada-inercia-coriolis} se obtiene el sistema de ecuaciones \textbf{[sistema de ecuaciones]}. 
