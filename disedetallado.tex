...
para que: compensar los efectos de las no linealidades

como: el script linealiza en varios valores de Omega y recalcula las ganancias y todas las matrices que resultan de esto son guardadas en una matriz de tres dimensiones que será usada para la simulación 

\subsection{Discretización}

como los controladores suelen ser implementados en un sistema digital es necesario contar con una discretizacion de los controladores presentados anteriormente

como se indica en la seccion [] para emular un controlador-observador es necesario transformar los polos que definen la respuesta del sistema en lazo cerrado mediante la aproximación de Tustin expresada en la ecuación [ecuacion de tustin] 

para el calculo de las ganancias del controlador discreto es necesario primero discretizar el sistema continuo y con el nuevo conjunto de polos discretos aplicamos la técnica de ubicación de polos usada en la sección [...] 

el sistema queda implementado en el modelo de \textbf{Simulink} mostrado en la figura [...]

\subsection{Observador de Kalman}

el ruido puede afectar la estabilidad de un sistema controlado 

el observador de kalman permite mejorar la calidad de nuestras mediciones gracias a que incorpora informacion sobre la dinamica del sistema 

a partir del sistema discretizado se implementan las formulas de observador de kalman descritas en la seccion []

ademas agrega la ventaja de que integra la informacion de los tres sensores del rodamiento magnetico sin mayor problema 

las ganancias del observador de kalman a diferencia de las ganancias del observador clasico son calculadas en linea y de manera iterativa 

el algoritmo queda implementado en el modelo de \textbf{Simulink} mostrado en la figura [...]
