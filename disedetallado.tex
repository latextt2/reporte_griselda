...
\section{Rodamiento magnéticos radial}
\begin{figure}[htb]
    \centering
    \includegraphics[width=\textwidth]{images/Capitulo_3/diagrama_funcional_rmr}
...
\section{Rodamiento magnéticos axial}
\begin{figure}[htb]
    \centering
    \includegraphics[width=\textwidth]{images/Capitulo_3/diagrama_funcional_rma}
...
\begin{figure}[htb]
    \centering
    \includegraphics[width=\textwidth]{images/Capitulo_3/diagrama_funcional_mcce}
...
\begin{figure}[htb]
    \centering
    \includegraphics[width=\textwidth]{images/Capitulo_3/diagrama_funcional_sdc}
    \caption{Sensor de distancia capacitivo}
\end{figure}
\subsection{Electrodo}
\subsection{Acondicionamiento}
\section{Collarín de levitación}
\begin{figure}[htb]
    \centering
    \includegraphics[width=\textwidth]{images/Capitulo_3/diagrama_funcional_cl}
    \caption{Collarín de levitación}
\end{figure}
\section{Controlador}
\begin{figure}[htb]
    \centering
    \includegraphics[width=\textwidth]{images/Capitulo_3/diagrama_funcional_controlador}
    \caption{Controlador}
\end{figure}
...
\section{Rodamientos magnéticos axiales}
\begin{figure}[htb]
    \centering
...
\begin{figure}[htb]
\centering
	\includegraphics[scale=1]{images/Capitulo_3/Rosca}
