...
Entonces para el correcto modelado del electroimán necesitamos incluir los efectos del flujo marginal. En [??] se presenta un nuevo método para modelar la reluctancia de un entrehierro. Usando este nuevo modelo los resultados de la simulación se acercan en un n\%.   
