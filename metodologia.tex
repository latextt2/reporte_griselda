...
\end{equation}
El sistema es de estado completamente controlable si y solo si la matriz $M_c$ de $n \times nr$ tiene rango $n$, o sea que contenga n vecorres columna linealmente independientes.
