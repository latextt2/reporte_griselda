...
Cuando se aplica una fuerza en algún punto de un cuerpo rígido, dicho cuerpo tiende a realizar un movimiento de rotación en torno a algún eje,  la propiedad de la fuerza aplicada para hacer girar al cuerpo se mide con una magnitud física que llamamos torque o momento de la fuerza. Por lo que el  torque o momento de una fuerza es la capacidad de dicha fuerza para producir un giro o rotación alrededor de un punto.
...
Para aclarar concepto podemos usar como ejemplo un robot que trata de determinar su posicion representada mediantes la variable x

para sabemos con cierta certeza que estamos en una posicion representado mediante la distribucion x(t) y sabemos que las llantas giran a un velocidad u entonces podemos predecir que ahora estamos otra posicion x_k+1. sin embargo debido a que imperfecciones en el camino, las llantas, del robot, arrastre del aire,  y demas es posible que no tengas un movimiento exacto de tu, esta incertidumbre queda cuantificada en el ruido de proceso w. si suponemos que ambas distribucion son gausianas entonces tenemos que la nueva distrubion x_t tiene la forma fig??, como se puede ver esta distribucion tiene una mayor varianza, o sea tenemos menos certeza sobre los posicion del robot antes de realizar el movimiento.
