...
Debido a que todas todos los metodos presentados a continuacion operan sobre sistemas lineales es necesario presentar un metodo para linealizar un sistema no lineal.

Si se tiene un sistema no lineal de la forma
\begin{equation}
	\dot{x} =  f(x,u)
\end{equation}

Se define un punto de equilibrio como un conjunto de valores $\bar{x}$, $\bar{u}$ donde se cumple que
\begin{equation}
	f(\bar{x},\bar{u}) = 0_n
\end{equation}
