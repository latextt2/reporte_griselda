...
El momento angular de un sistema de partículas se conseva si ningún torque externo es aplicado, esto es, la razón de cambio del momento angular de un cuerpo es la suma de los momentos de torsión aplicados sobre este.
...
Cuando modelamos sistemas, es común la aparición de sistemas no lineales, y encotramos el problema de que toda la teoría presentada sobre el control esta centrada en sistemas lineales. En lugar de desarrollar una teoría separada para su manejo, se presenta un método para aproximar un sistema no lineal en uno lineal.
\begin{equation}
...
Se dice que un sistema es controlable, si se puede trasferir desde cualquier estado inicial $x(t_0)$ cualquier otro estado mediante un vector de control sin restricciones, en un intevalo de tiempo finito.\\
