...
\end{equation}
como los ejes ahora se mueven con el objecto la matriz de inercia se mantiene constante, y por tanto sus derivada son cero, si consideramos que la velocidad angular del cuerpo $\omega$ y la velocidad angular del marco movil $\Omega$ es la misma entonces podemos expandir la ecuacion ?? en la forma
...
\todo[inline]{formulas}
\todo[inline]{ecuaciones  controlabilidad}

\begin{equation}
	[B | AB |\cdots| A^{n-1}B]
\end{equation}
\begin{equation}
	[B i| AB |\cdots| A^{n-1}B]
\end{equation}
\begin{equation}
	\dot{x} =  Ax + Bu
\end{equation}
...
\todo[inline]{ecuaciones  observalidad}
