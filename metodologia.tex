...
\begin{equation}
	H_o = \sum{}{ r_i \times L_i}
\end{equation}
para un solido rigido tenemos
\begin{equation}
\label{eq:fisica:momento_angular_integral}
 H_o = \int{r_o \times vdm} = \int{r_o \times \omega \times r_o dm} 
\end{equation}
...
\todo[inline]{ecuacion :v}
o
\todo[inline]{ecuacion :v}
donde a $I_G$ se le cononce como tensor de inercia, el tensor de inercia refleja la distribución de masa de un cuerpo en rotación respecto a un eje de giro y es una medida de su inercia rotacional. El momento de inercia solo depende de la geometría del cuerpo y de la posición del eje de giro.
