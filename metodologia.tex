...
\begin{equation}
	...
	\dot{x} =  f(x,u)
\end{equation}
Consideremos el sistema no lineal \ref{eq:control:nolineal} donde $f$ es un mapeo de $R^{n} \times R^{m} \to R^{n}$. En caso que la funcion $f$ evaluara cero el sistema  permaneceria constante o en equilibro. Se define un punto de equilibrio como un conjunto de valores $\bar{x}$, $\bar{u}$ donde se cumple que
\begin{equation}
	f(\bar{x},\bar{u}) = 0_n
\end{equation}
...
aproximando usando los dos priemeros terminos de la serie de taylor
