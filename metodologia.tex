...
Se dice que un sistema es controlable si se puede trasferir desde cualquier estado inicial $x(t_0)$ a cualquier otro estado mediante un vector de control sin restricciones en un intervalo de tiempo finito.\\
