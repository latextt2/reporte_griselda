...
Sin embargo, para otros medios (particularmente materiales ferromagnéticos), $B$ no es una fusión lineal de $H$ ni posee un mismo valor de $H$ para uno de $B$.

Ahora consideramos los efectos que un material tiene sobre la inducción magnética $B$ cuando un campo magnetizante pasa a través de él. Esto esta representado por la magnetización, que puede ser incrementada en los materiales ferromagnéticos o reducida como es en el caso de los diamagnéticos. La permeabilidad relativa del material indica como varía el comportamiento de la inducción en el material con respecto a la inducción en el vacío.
