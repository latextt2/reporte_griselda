...
\todo[inline]{Se define el momento de inercia}
...
El momento de inercia desempeña un papel análogo al de la masa inercial en el caso del movimiento rectilíneo y uniforme. (WIKI)
...
\todo[inline]{Se introducen los angulos de auler, y porque estos solucion el problema de calcular el momento angular}
% primera parte
\begin{equation}
	\mathcal{W_B} = \begin{pmatrix}
	W_x\\
	W_y\\
	W_z
